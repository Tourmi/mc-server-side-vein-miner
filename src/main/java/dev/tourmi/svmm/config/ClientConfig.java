...
public class ClientConfig {
    ...
    public ClientConfig() {
        ...
        GIANT_VEIN_MINING_DISABLED = builder.comment("Whether or not the player disabled giant vein mining for themselves").define("giant_vein_mining_disabled", false);
